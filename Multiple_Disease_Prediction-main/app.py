...
# Function to simulate a simple login system (in a real app, you'd use a database)
...
# Setting session state for role and login status
...
if not st.session_state.logged_in:
    ...
    # User type selection
    user_type = st.selectbox("Select User Type", ["patient", "doctor", "admin"])
...
# If logged in, redirect to the appropriate page based on the role
if st.session_state.logged_in:
    ...
    # Patient Page with Disease Prediction
